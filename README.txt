...
Anyway, storing of comments, annotations and changes to a resource served from a web server is not necessarily the provencen of that server.

I would like to create a system of *distributed annotation infrastruicture*
...
4. Then the js client also posts a hash of the URL and the locaiton of the comment to an indexing service
5. the indexing service is the infrastructure - and it is dstributed over multipe domains.
6. the indexing service is realtively simple - for a given URL / URL hash it returns a json list of URLS where comments about that URL can be found.
